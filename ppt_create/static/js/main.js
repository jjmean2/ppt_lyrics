...
var Line = function Line(text) {
  ...
  this.inferedCategory =
    (_categories$reduce = categories.reduce(function (result, current) {
      var _result$score
      ...
      if (
        score !== undefined &&
        score >
          ((_result$score = result === null || result === void 0 ? void 0 : result.score) !==
            null && _result$score !== void 0
            ? _result$score
            : -1)
      ) {
        return {
      ...
      return result
    }, undefined)) !== null && _categories$reduce !== void 0
      ? _categories$reduce
      : {
  ...
  function LineParser(text) {
    ...
    this.lines = text
      ...
      .reduce(function (result, current) {
        ...
        var lastLine =
          (_result = result[result.length - 1]) !== null && _result !== void 0 ? _result : ''
          ...
          if (currentPart.category === LineCategory.separator) {
            ...
            var _ret = (function () {
              ...
              console.error(
                ...
                (_songParts =
                  songParts[
                    titleEndIndex !== null && titleEndIndex !== void 0 ? titleEndIndex : -1
                  ]) === null || _songParts === void 0
                  ? void 0
                  : _songParts.lines,
              )
      ...
      value: function toFormText() {
        var method =
          arguments.length > 0 && arguments[0] !== undefined
            ? arguments[0]
            : _SongParser.SlideConvertMethod.withFlowOrder
    ...
    },
    {
      ...
      value: function toSlides() {
        var method =
          arguments.length > 0 && arguments[0] !== undefined
            ? arguments[0]
            : SlideConvertMethod.withFlowOrder
